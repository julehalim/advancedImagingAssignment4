...
% add some stuff about how the Resnet50 is the backbone of fasterRCNN; use more images from the paper they give
...
%write about how i tested different aspect ratio boundaries and found avgL/avgW to be the highest.
\begin{lstlisting}[]
