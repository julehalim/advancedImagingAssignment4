...
\begin{minipage}{\linewidth}
  ...
  \captionof{figure}{Predicted Bounding Boxes Plotted With Ground Truth}
  \label{fig:bboxplot1}
\end{minipage}
...
\begin{minipage}{\linewidth}
  ...
  \captionof{figure}{Predicted Bounding Boxes Plotted With Ground Truth Without Differentiation of Aspect Ratios}
  \label{fig:bboxplot2}
\end{minipage}
...
\begin{minipage}{\linewidth}
  ...
  \captionof{figure}{Confusion Matrix of Correctly Predicted Orientations}
...
groundTruthData = table('Size',[1,1], ...
    ...
    'VariableNames', {'Boxes'})
groundTruthData.Boxes{1} = ParkingSlots
[averagePrecision, recall, precision] = evaluateDetectionPrecision
(detectionResults, groundTruthData)
figure;
plot(recall, precision,'-x');
xlabel('Recall');
ylabel('Precision');
...
for i = 1:size(ParkingSlots,1)
    rectangle('Position', ParkingSlots(i,:), 'EdgeColor', 'r', 'LineWidth',
     1);
end
hold off;
...
for i = 1:size(newBoxes,1)
    rectangle('Position', newBoxes(i,:), 'EdgeColor', 'black',
     'LineWidth', 1);
end
